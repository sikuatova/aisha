...
bg = pygame.image.load(r'C:\Users\Айша\OneDrive\Рабочий стол\1week\7week\main-clock.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"C:\Users\Айша\OneDrive\Рабочий стол\1week\7week\left-hand.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load(r"C:\Users\Айша\OneDrive\Рабочий стол\1week\7week\right-hand.png")
